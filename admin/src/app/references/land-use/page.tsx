...
export default function LandUsePage() {
    ...
    const fetchItems = async () => {
        try {
            const res = await fetch(`${API_URL}/api/admin/references?type=land_use`, {
        ...
        try {
            if (editingItem) {
                ...
                await fetch(`${API_URL}/api/admin/references`, {
                    ...
                    body: JSON.stringify({ ...formData, type: "land_use" }),
                });
            }
            setDialogOpen(false);
            fetchItems();
        ...
        <div className="min-h-screen bg-background p-8">
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-3xl font-bold">Виды разрешённого использования</h1>
                </div>
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Индивидуальное жилищное строительство"
                            />
                        </div>
                        <div className="space-y-2">
