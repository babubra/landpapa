...
def seed_settings(db: Session):
    ...
    default_settings = [
        ...
        },
        {
            ...
            "value": "",
            "description": "Имя бота для авторизации (без @, например rkkland_bot)"
        },
        {
            "key": "tg_proxy_type",
            "value": "http",
            "description": "Тип прокси для Telegram: http или socks5"
        },
        {
            "key": "tg_proxy_host",
            "value": "",
            "description": "IP или хост прокси для Telegram (пусто — отправлять напрямую)"
        },
        {
            "key": "tg_proxy_port",
            "value": "",
            "description": "Порт прокси для Telegram"
        },
        {
            "key": "tg_proxy_user",
            "value": "",
            "description": "Логин прокси для Telegram (если прокси без авторизации — оставить пустым)"
        },
        {
            "key": "tg_proxy_password",
            "value": "",
            "description": "Пароль прокси для Telegram"
        },
        {
            "key": "privacy_policy",
